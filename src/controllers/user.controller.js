...
/*
validateBeforeSave is an option that tells
 Mongoose whether to run schema validations
  before saving a document to the database.
...
const updateAccountDetails = asyncHandler(async(req,res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,user,"Account Details updated Success"))
})
